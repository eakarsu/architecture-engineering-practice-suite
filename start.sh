...
PORT="${PORT:-5490}"
DB_NAME="${PGDATABASE:-architecture_engineering_practice_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Architecture Engineering Practice Suite"
echo "======================================="
echo
...
echo "Starting architecture engineering practice suite frontend on http://localhost:$PORT"
echo "Login: admin@architecture-engineering-practice.local / admin123"
