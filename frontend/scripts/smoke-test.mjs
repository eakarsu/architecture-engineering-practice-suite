const baseUrl = process.env.SMOKE_BASE_URL || 'http://127.0.0.1:5490';
...
const adminCookie = await login('admin@architecture-engineering-practice.local', 'admin123');
const managerCookie = await login('manager@architecture-engineering-practice.local', 'manager123');
const analystCookie = await login('analyst@architecture-engineering-practice.local', 'analyst123');
