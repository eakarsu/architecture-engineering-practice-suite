...
const entitySeeds = [
  ...
  ["floor-plan-review","Floor Plan Review Records","Floor Plan Review operating queue","Open","Floor Plan Review follow-up list","Floor Plan Analyzer","$0"],
  ["space-utilization","Space Utilization Records","Space Utilization operating queue","Review","Space Utilization follow-up list","Floor Plan Analyzer","$0"],
  ["code-layout-issues","Code Layout Issues Records","Code Layout Issues operating queue","Review","Code Layout Issues follow-up list","Floor Plan Analyzer","$0"],
