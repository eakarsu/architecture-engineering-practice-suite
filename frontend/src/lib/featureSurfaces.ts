...
const featureSeeds = [
  ...
  ["floor-plan-review","Floor Plan Review","Floor Plan Review review queue","Floor Plan Analyzer","Review source context and assign owner"],
  ["space-utilization","Space Utilization","Space Utilization review queue","Floor Plan Analyzer","Confirm next action and update evidence"],
  ["code-layout-issues","Code Layout Issues","Code Layout Issues review queue","Floor Plan Analyzer","Confirm next action and update evidence"],
