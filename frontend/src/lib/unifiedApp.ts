...
const features = [
  {
    ...
    summary: 'Records workflow normalized for the Architecture Engineering Practice suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Users,
    summary: 'Workspaces workflow normalized for the Architecture Engineering Practice suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ClipboardList,
    summary: 'Requests workflow normalized for the Architecture Engineering Practice suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: CalendarCheck,
    summary: 'Cases workflow normalized for the Architecture Engineering Practice suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Activity,
    summary: 'Schedules workflow normalized for the Architecture Engineering Practice suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Workflow,
    summary: 'Resources workflow normalized for the Architecture Engineering Practice suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: FileText,
    summary: 'Approvals workflow normalized for the Architecture Engineering Practice suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ShieldCheck,
    summary: 'Exceptions workflow normalized for the Architecture Engineering Practice suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: BarChart3,
    summary: 'Compliance workflow normalized for the Architecture Engineering Practice suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: PackageCheck,
    summary: 'Analytics workflow normalized for the Architecture Engineering Practice suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Bell,
    summary: 'Forecasts workflow normalized for the Architecture Engineering Practice suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Intelligence Layer',
    icon: Files,
    summary: 'Reports workflow normalized for the Architecture Engineering Practice suite with records, queues, approvals, audit, and reporting.',
  ...
  {
    slug: "floor-plan-review",
    title: "Floor Plan Review",
    href: "/floor-plan-review",
    category: "Floor Plan Analyzer",
    icon: Workflow,
    summary: "Floor Plan Review elevated from the Floor Plan Analyzer source capability with records, queues, AI assistance, audit, and reporting.",
    bullets: ["Floor Plan Review queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Floor Plan Review", value: "24", note: 'Active' },
  ...
  },
  {
    ...
    href: "/space-utilization",
    category: "Floor Plan Analyzer",
    icon: Workflow,
    summary: "Space Utilization elevated from the Floor Plan Analyzer source capability with records, queues, AI assistance, audit, and reporting.",
    bullets: ["Space Utilization queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Space Utilization", value: "33", note: 'Active' },
      { label: 'Review', value: "5", note: 'Needs attention' },
      { label: 'Due Soon', value: "4", note: 'Next 14 days' },
    ],
  },
  {
    slug: "code-layout-issues",
    title: "Code Layout Issues",
    href: "/code-layout-issues",
    category: "Floor Plan Analyzer",
    icon: Workflow,
    summary: "Code Layout Issues elevated from the Floor Plan Analyzer source capability with records, queues, AI assistance, audit, and reporting.",
    bullets: ["Code Layout Issues queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Code Layout Issues", value: "42", note: 'Active' },
  ...
  },
  {
    ...
    icon: Files,
    summary: 'Architecture Engineering Practice documents, packets, evidence, attachments, and exports.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Bell,
    summary: 'Architecture Engineering Practice alerts, reminders, exceptions, and approvals.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Plug,
    summary: 'Architecture Engineering Practice source-system connector health and sync status.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: UserRound,
    summary: 'Architecture Engineering Practice users, roles, teams, permissions, and ownership settings.',
...
const aiFeatures = [
  {
    ...
    category: 'Intelligence Layer',
    icon: Bot,
    summary: 'Architecture Engineering Practice assistant for triage, summaries, drafting, recommendations, and operational review.',
...
export const featureFamilies = [
  ...
  { name: 'Floor Plan Analyzer', features: ["Floor Plan Review","Space Utilization","Code Layout Issues"] },
...
export const featureContexts: Record<string, FeatureContext> = Object.fromEntries(
  allFeatures.map((feature) => [
    feature.title,
    {
      sourceOwners: ['AIArchitectureEngineeringPracticeAssistant', 'AIArchitectureEngineeringPracticeOperations where applicable'],
