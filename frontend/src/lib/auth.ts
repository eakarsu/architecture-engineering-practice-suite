export const AUTH_COOKIE = 'architecture_engineering_practice_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@architecture-engineering-practice.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@architecture-engineering-practice.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@architecture-engineering-practice.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
